...
2. Pick a location on your computer (or your team's own network folder) to save the data file — this will be your primary file.
...
4. Optionally, use the **"🗄 Backup"** button at the top to set up a safety mirror (e.g. a network folder for your own team) — this is entirely independent of everything else.
